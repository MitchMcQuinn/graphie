...
----------------
This module provides a SessionManager class that encapsulates common operations
for managing session state in Neo4j.
...
# Create a global session manager getter function
